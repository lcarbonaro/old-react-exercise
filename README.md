...
The Royal Bank of Flatiron Transaction Tracker

This is a simple React web application that allows a user to track thier transactions. Filter using the search bar and the date, amount, description and category will show.

Features

Add new transactions with the description, amounts and categories as per date selected
...
RUn 'npm install', this will install the project dependecies needed.
Start the development server with 'npm start'.
Access the application in your web at http://localhost:3000.

ownership

Rights to this project are reserved by @Epharus, however this project can be used for the right purposes.
